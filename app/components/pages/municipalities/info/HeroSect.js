  ...
  return (
    <>
      <div className="relative h-full m-auto">
        ...
        <div className="absolute flex flex-col top-36 ml-[20px] justify-between l eft-1/2 tran  sform -tr anslate-x-1/2 m-auto z-0">
          <div>
            <p className="text-white text-lg font-semibold">Municipalities</p>
            <p className="text-white text-4xl font-semibold leading-tight tracking-wide">
              {dataArr[0]?.title}
            </p>
          </div>
