      ...
      <div className=" mt-5 flex items-center justify-center">
        <div className="flex flex-col  w-[1347px] 1xl:w-[90%]   gap-10 pb-20">
          <div className="flex flex-col gap-10   p-7 bg-[#036C73]">
            <div className="flex flex-row gap-10 sm:gap-4">
              <div className="bg-white p-2 px-6 md:p-1 md:px-4 rounded-lg sm:h-[75px] sm:w-[75px] flex flex-col items-center justify-center ">
                <p className="text-4xl font-semibold text-customColor  md:text-2xl">
                  03
                </p>
                <p className="text-xl text-customColor md:text-sm">JAN</p>
              </div>
              <p className="text-4xl font-semibold text-white w-[70%] lg:w-[90%] 2md:text-3xl md:text-2xl sm:text-xl">
                ...
                {recentData.map((item, index) => {
                  return (
                    ...
                    >
                      <img
                        src={item.img}
                        className="w-full 2md:h-[450px] sm:h-[300px] object-cover"
                        alt=""
                      />
